...
export b_radius=$(( b_height*12/100 ))   # block rad 10% of height (type1)
export c_radius=$(( b_height*12/100 ))   # block rad 10% of height {type2}
export t_radius=$(( b_height*12/100 ))   # tooltip rad 10% of height
export e_margin=$(( b_height*0/100 ))   # block margin 30% of height
export e_paddin=$(( b_height*0/100 ))   # block padding 10% of height
export g_margin=$(( b_height*15/100 ))   # module margin 14% of height
export g_paddin=$(( b_height*20/100 ))   # module padding 15% of height
export w_radius=$(( b_height*10/100 ))   # workspace rad 10% of height
...
export w_padact=$(( b_height*30/100 ))   # workspace active padding 40% of height
export s_fontpx=$(( b_height*35/100 ))   # font size 36% of height
